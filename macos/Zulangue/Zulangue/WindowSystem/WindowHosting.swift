...
enum WindowHosting {
    ...
    static func installPinnedContentView<Content: View>(
        ...
        policy: WindowHostingPolicy = .fixedWindowOwned
    ...
    private static func apply<Content: View>(
        ...
        if #available(macOS 15.0, *) {
            // AppKit-owned windows should not let SwiftUI bridge title/toolbars
            // or any other scene-level window behavior back onto the NSWindow.
